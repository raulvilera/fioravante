...
const SCHOOL_CONFIGS: Record<string, SchoolConfig> = {
  fioravante: {
    id: 'fioravante',
    fullName: 'EE Fioravante Iervolino',
    shortName: 'Fioravante',
  },
};

export const getSchoolConfig = (schoolId: string): SchoolConfig => {
  return SCHOOL_CONFIGS[schoolId] ?? SCHOOL_CONFIGS['fioravante'];
};
